...
const slideWidth = 192; //한개의 슬라이드 넓이 
const slideMargin = 0; //슬라이드간의 margin 값 

//전체 슬라이드 컨테이너 넓이 설정 
slides.style.width = (slideWidth + slideMargin) * slideCount + 'rem'; 
function moveSlide(num) { 
    slides.style.left = -num * 192 + 'rem'; currentIdx = num; 
} 
...
//출처: https://eunhee-programming.tistory.com/106 [코드짜는 문과녀]